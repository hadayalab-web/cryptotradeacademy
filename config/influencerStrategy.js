...
// 【引用リポストCron】vercel.json 最適化: 言語ごとに分を分散（バースト防止・X API負荷分散）
//   EN :00, ES :10, PT-BR :20, AR :30, KO :40, JA :50（JAは 0-8,12-16 UTC のみ = 14回/日）
 ...
 * ピーク: Cryptoアクティブ時間（Asia 0-4, EU 8-12, US 14-22 UTC）を優先参照用に定義。
 */
const HOURLY_DISTRIBUTION = {
  peak: {
    hours: [0, 1, 2, 3, 4, 8, 9, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 21, 22],
    multiplier: 1.0
  },
  offPeak: {
    hours: [5, 6, 7, 13, 23],
