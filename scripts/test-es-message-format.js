...
console.log('📱 Versión Gratuita (Minimal Version) Mensaje');
console.log('='.repeat(80));
console.log('');
...
console.log('');
console.log('='.repeat(80));
console.log('💎 Versión de Pago (Regular Briefing) Mensaje');
console.log('='.repeat(80));
console.log('');
...
const regularMessage = formatRegularBriefing({
  ...
  psychologicalSupport: {
    ...
    psychologicalAdvice: '✅ Estado neutral - No se detectaron bloqueos mentales: El sentimiento del mercado está equilibrado. No se detectaron emociones extremas. Las condiciones son estables.',
  },
...
console.log('');
console.log('='.repeat(80));
console.log('✅ Generación de mensajes completa');
console.log('='.repeat(80));
