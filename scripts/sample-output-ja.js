#!/usr/bin/env node
/**
 * JA（日本語）版 Minimal & Regular のサンプル出力
 *
 * 実行: node scripts/sample-output-ja.js
 * ファイル出力: node scripts/sample-output-ja.js --out output/ja-sample.txt
 */
...
function main() {
  ...
  const regularMessage = formatRegularBriefing({
    ...
    psychologicalSupport: {
      ...
      psychologicalAdvice: '✅ 中立状態 - メンタルブロック未検出: 市場センチメントはバランスが取れている。',
    },
