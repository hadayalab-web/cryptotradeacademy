...
// ペルソナ分析に基づく人物指定: 痛みピーク・即決ミレニアル 28-35、Z世代 22-27。おっさん・中年男性にしない。
const STYLE =
  "Create a single-panel editorial cartoon in the style of classic newspaper political cartoons (like The New Yorker or Herblock). Black and white ink drawing with clear line work and cross-hatching. No photos, no 3D. Keep it tasteful and editorial, not grotesque. Add a short fictional newspaper-style caption at the bottom in English only. CRITICAL – Persona-based character design: Target is millennials (28–35) and Gen Z (22–27). Draw characters as YOUNG ADULTS in their 20s or early 30s. Do NOT draw middle-aged or older men (no 'ossan' / 40s–50s look). Diverse genders. Viewers must see themselves as 22–35.";
...
Scene: A young trader (20s–30s, any gender) stares into a large mirror. In the mirror reflection we see "-40%" or "CRASH" or "LIQUIDATED" instead of their face, or the mirror shows a crumbling chart. They are frozen, unable to look away. Mood: facing the truth. Caption at bottom: "REALITY CHECK."`
  },
  {
...
Scene: A young trader (20s–30s, any gender) frozen at their desk, hand on mouse, eyes wide. Behind them a large wall clock has stopped. The screen shows a crashing chart and "-40%." Papers and coffee untouched. Mood: time stood still, paralysis. Caption at bottom: "TIME OUT."`
  }
];
