...
async function sendVSL2LastCall() {
  try {
    ...
    const freeUsers = getFreeUsersForVSL2LastCall();
    ...
    for (const user of freeUsers) {
      try {
        ...
        markVSL2LastCallSent(user.chatId);
