...
async function postMinimalVersionToX(targetLangs, reportData) {
  ...
  for (let i = 0; i < targetLangs.length; i++) {
    ...
    try {
      ...
      const whopLinkWithPromo = `${whopLink}?promo=${getPromoCode().toUpperCase()}`;
