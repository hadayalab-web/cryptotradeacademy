...
**画像添付**: VSL1サムネイル画像（`public/images/thumbnails/vsl1_thumbnail.png`）
...
- `services/telegram/messages/vsl1-reminder.js` (メッセージテンプレート)
- `api/vsl1-reminder.js` (配信ロジック)
...
**画像添付**: VSL1リマインド専用サムネイル画像（`public/images/thumbnails/vsl1_reminder_thumbnail.png`）
...
2. **VSL1リマインド**: `services/telegram/messages/vsl1-reminder.js`
3. **VSL2**: `services/telegram/messages/vsl2.js`
4. **VSL2 Last Call**: `services/telegram/messages/vsl2-last-call.js`
