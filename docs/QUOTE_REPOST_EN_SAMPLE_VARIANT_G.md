...
**構成**: ヘッドライン → Gemini（CQ＋無様なペルソナ）→ チラ見せ＋リンク説明 → GPT-5-mini（同じCQで反論処理）→ CTA

- **フック**: gemini-3-flash-preview に CQ データを渡して市況＋無様なペルソナ言及。
- **反論**: gpt-5-mini-2025-08-07 に**同じ CQ データ**を渡してペルソナに効く反論処理。フックと反論の両方に CQ を渡すことで刺さりやすいメッセージに。
