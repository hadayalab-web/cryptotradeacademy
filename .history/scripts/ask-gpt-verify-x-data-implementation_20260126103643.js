  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'あなたはX（Twitter）API v2の専門家で、データ取得の正確性を検証するエキスパートです。実装コードを徹底的にチェックし、問題点と改善案を具体的に提示してください。',
        },
        {
          role: 'user',
          content: prompt,
    ...
    const outputPath = path.join(__dirname, '../docs/GPT_X_DATA_IMPLEMENTATION_REVIEW_2026-01-26.md');
