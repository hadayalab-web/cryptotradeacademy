...
const OPENAI_API_KEY =
  ...
  "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";
      ...
      messages: [
        {
          role: "system",
          content:
            "あなたはX（Twitter）API v2の専門家です。正確で実践的なアドバイスを提供してください。"
        },
        {
          role: "user",
          content: prompt
