...
const segment = raw.toLowerCase().replace(/\.utf-8$/i, "").split(/[._-]/)[0];
const supported = ["en", "ja", "es", "pt-br", "ar", "ko"];
const langFinal =
  segment === "pt" ? "pt-br" : supported.includes(segment) ? segment : "en";
...
async function main() {
  ...
  console.log(`CQ: Trap ${reportData.trapScore}, BTC $${reportData.priceUsd}, 24h ${reportData.change24h}%`);
  console.log("");
