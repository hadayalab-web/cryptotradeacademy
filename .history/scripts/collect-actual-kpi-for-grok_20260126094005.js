...
async function collectActualKpiForGrok() {
  ...
  console.log(`   - Minimal Version: ${actualKpi.impressions.minimalVersion.toLocaleString()}（推定値）`);
  ...
  console.log(`   24時間換算（単純計算）: ${Math.round(actualKpi.telegramOptIns.total * multiplier)}人`);
