...
| ar       | 40      | 37 件  | **36 件**  | ar 増強で build + rebuild、+22。目標40まであと4。         |
| **合計** | **620** | —      | **284 件** | ar 増強後。en 124, pt-br 35, ko 30, es 48, ja 11, ar 36。 |
...
- **ar**: build × 1（batch 25）+ rebuild → シード 14 → 37、KV **36 件**（+22、目標40まであと4）。
- **KV 合計**: 200 → **284 件**（ar 増強後）。
