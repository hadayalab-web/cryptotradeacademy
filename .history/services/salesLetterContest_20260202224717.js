...
- Paragraph 2: Tease FREE Minimal Version—Trap Score, gut vs data, no card. What they see, why it matters, what they miss if they don't try.
- Paragraph 3: Tease PAID Regular Briefing—15min Alerts + Exit Map, $99/mo, 1-day trial, risk zero. Code DEFEND50 for 50% off (once).
- Paragraph 4 (optional): Soft close. "You're not alone. Get the framework. Act now." Add exactly one short VSL tease line—curiosity only, not verbose. Examples: "The secret is in the video." / "ビデオメッセージに秘密が隠されている。" Do NOT list "free VSL", "upgrade VSL", "link below" or repeat CTA. One line only.
...
Output the full post: headline, then body (one short VSL tease line only, e.g. "The secret is in the video."), then hashtags. No other labels or section headers—just the headline line, blank line, body paragraphs, blank line, hashtag line.`;
}
