...
- Paragraph 4 (optional): Soft close. "You're not alone. Get the framework. Act now."
No URLs in the body. Tone: ${TONE}. Every sentence ends with a period (or 。 in Japanese).

3) HASHTAGS
End with 2–4 hashtags on a new line. Include #BTC and #TrapDefence. Add 1–2 more if they fit (e.g. #Crypto #Trading).

Output the full post: headline, then body, then hashtags. No other labels or section headers—just the headline line, blank line, body paragraphs, blank line, hashtag line.`;
}
