...
/**
 * 有料版（Regular）月$99トライアル CTA 文言（ペルソナ解析 2026-02: 1日トライアル・リスクゼロ訴求）
 * X投稿末尾などで「今すぐ月$99トライアル: [url]」と統一して使う
 * @param {string} lang - 言語コード
...
function getRegularTrialCta(lang = null) {
  ...
  const textByLang = {
    ...
    es: `Prueba $99/mes (1 día gratis): ${url}`,
    "pt-br": `Teste $99/mês (1 dia grátis): ${url}`,
    ar: `تجربة $99/شهر (يوم مجاني): ${url}`,
    ko: `월 $99 체험 (1일 무료): ${url}`
  };
  return {
