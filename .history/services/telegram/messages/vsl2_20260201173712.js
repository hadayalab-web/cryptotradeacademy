...
const VSL2_MESSAGES = {
  ...
  // ------------------------------------------------------------------
  en: (userName, vsl2Link, whopUrl, promoCode) => `🚨 **${userName}, Don't Miss This - Your Trading Is At Risk!**
...
💡 *One missed signal = -10% loss. Upgrade = bulletproof defense.*`,
  ...
  // ------------------------------------------------------------------
  ja: (userName, vsl2Link, whopUrl, promoCode) => `🚨 **${userName}さん、見逃すな - あなたのトレードは危険にさらされています！**
