        ...
        try {
          ...
          if (ENABLE_TELEGRAM) {
            ...
            if (process.env[channelIdEnvVar]) {
              ...
              console.warn(
                `[Telegram] No channel ID configured for ${series}/${marketCode} (env: ${channelIdEnvVar}) or TELEGRAM_CHAT_ID`
              );
            }
        ...
        try {
          ...
          if (ENABLE_TELEGRAM) {
            ...
            if (minimalChatId) {
              ...
              console.warn(
                `[Free Version] No chat ID found for ${targetLang}, skipping free version delivery`
              );
            }
          }
